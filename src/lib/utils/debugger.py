...
class Debugger(object):
    def __init__(self, ipynb=False, theme='black',
        ...
        elif num_classes == 1 or dataset == 'refined_corners':
            self.names = refined_corners_class_names
    ...
    def add_coco_bbox(self, bbox, cat, conf=1, show_txt=True, img_id='default'):
        ...
        cv2.circle(self.imgs[img_id], (pred_center_x, pred_center_y), int(10 * conf), (0, 0, 255), 2)
        if show_txt:
            vis_x = pred_center_x - 10
            vis_y = pred_center_y - 10
...
refined_corners_class_names = ['corner']
